...
end through :class:`~locus.tools.executor.SequentialExecutor`.
"""
...
class TestExecutorRedactsVendorKeys:
    ...
    async def test_openai_key_in_error_redacted(self) -> None:
        ...
        def leak_openai() -> str:
            fake = (
                "sk-proj-" + "KXOiNAJ9PGGIeOSZYf4OnM7WASY8kV8Y2eySwx5"
        ...
        assert not result.success
        assert "KXOiNAJ9PGGIeOSZYf4OnM7WASY8kV8Y2eySwx5" not in (result.error or "")
