...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/notebook_41_reasoning_patterns.py
```

Offline:

```bash
LOCUS_MODEL_PROVIDER=mock python examples/notebook_41_reasoning_patterns.py
```
...
```python
--8<-- "examples/notebook_41_reasoning_patterns.py"
```
