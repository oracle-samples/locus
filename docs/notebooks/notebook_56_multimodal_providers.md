...
Run it (OCI Generative AI is the default; auto-detected from `~/.oci/config`):
    ...
    python examples/notebook_56_multimodal_providers.py

Offline:

    LOCUS_MODEL_PROVIDER=mock python examples/notebook_56_multimodal_providers.py
...
```python
--8<-- "examples/notebook_56_multimodal_providers.py"
```
