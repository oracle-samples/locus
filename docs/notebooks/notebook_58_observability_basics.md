...
Run it (OCI Generative AI is the default; auto-detected from `~/.oci/config`):
    ...
    python examples/notebook_58_observability_basics.py

Offline:

    LOCUS_MODEL_PROVIDER=mock python examples/notebook_58_observability_basics.py

## Source

```python
--8<-- "examples/notebook_58_observability_basics.py"
```
