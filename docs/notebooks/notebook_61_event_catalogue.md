...
Run it (OCI Generative AI is the default; auto-detected from `~/.oci/config`):
    ...
    python examples/notebook_61_event_catalogue.py

Offline:

    LOCUS_MODEL_PROVIDER=mock python examples/notebook_61_event_catalogue.py

## Source

```python
--8<-- "examples/notebook_61_event_catalogue.py"
```
