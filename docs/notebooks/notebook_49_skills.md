...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/notebook_49_skills.py
```

Offline:

```bash
LOCUS_MODEL_PROVIDER=mock python examples/notebook_49_skills.py
```
...
```python
--8<-- "examples/notebook_49_skills.py"
```
