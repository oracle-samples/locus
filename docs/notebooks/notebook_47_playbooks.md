...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/notebook_47_playbooks.py
```

Offline:

```bash
LOCUS_MODEL_PROVIDER=mock python examples/notebook_47_playbooks.py
```
...
```python
--8<-- "examples/notebook_47_playbooks.py"
```
