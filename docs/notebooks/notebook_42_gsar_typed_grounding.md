...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/notebook_42_gsar_typed_grounding.py
```

Offline:

```bash
LOCUS_MODEL_PROVIDER=mock python examples/notebook_42_gsar_typed_grounding.py
```
...
```python
--8<-- "examples/notebook_42_gsar_typed_grounding.py"
```
