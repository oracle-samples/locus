...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/notebook_46_mcp_integration.py
```

Offline:

```bash
LOCUS_MODEL_PROVIDER=mock python examples/notebook_46_mcp_integration.py
```
...
```python
--8<-- "examples/notebook_46_mcp_integration.py"
```
