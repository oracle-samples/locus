...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/tutorial_23_functional_api.py
# or, fully offline:
LOCUS_MODEL_PROVIDER=mock python examples/tutorial_23_functional_api.py
```

## Source

```python
--8<-- "examples/tutorial_23_functional_api.py"
```
