...
```bash
python examples/tutorial_01_oci_transports.py            # all three
python examples/tutorial_01_oci_transports.py --transport responses
python examples/tutorial_01_oci_transports.py --transport sdk
python examples/tutorial_01_oci_transports.py --transport v1
```
...
```python
--8<-- "examples/tutorial_01_oci_transports.py"
```
