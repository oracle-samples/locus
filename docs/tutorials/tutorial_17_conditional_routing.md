...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/tutorial_17_conditional_routing.py
# or, fully offline:
LOCUS_MODEL_PROVIDER=mock python examples/tutorial_17_conditional_routing.py
```

## Source

```python
--8<-- "examples/tutorial_17_conditional_routing.py"
```
