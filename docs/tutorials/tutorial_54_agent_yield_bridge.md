...
Run it (OCI Generative AI is the default; auto-detected from `~/.oci/config`):
    ...
    python examples/tutorial_54_agent_yield_bridge.py

Offline:

    LOCUS_MODEL_PROVIDER=mock python examples/tutorial_54_agent_yield_bridge.py

## Source

```python
--8<-- "examples/tutorial_54_agent_yield_bridge.py"
```
