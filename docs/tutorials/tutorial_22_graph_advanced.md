...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/tutorial_22_graph_advanced.py
# or, fully offline:
LOCUS_MODEL_PROVIDER=mock python examples/tutorial_22_graph_advanced.py
```

## Source

```python
--8<-- "examples/tutorial_22_graph_advanced.py"
```
