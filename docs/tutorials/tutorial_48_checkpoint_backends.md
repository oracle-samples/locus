...
[tutorial 10](tutorial_10_agent_memory.md) is the developer default;
the [Oracle Database 26ai checkpointer](tutorial_07_oracle_26ai_checkpointer.md)
covered in tutorial 06 is the production recommendation.

## Source

```python
--8<-- "examples/tutorial_48_checkpoint_backends.py"
```
