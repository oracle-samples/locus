...
Run it (OCI Generative AI is the default; auto-detected from `~/.oci/config`):
    ...
    python examples/tutorial_47_guardrails_advanced.py

Offline:

    LOCUS_MODEL_PROVIDER=mock python examples/tutorial_47_guardrails_advanced.py

## Source

```python
--8<-- "examples/tutorial_47_guardrails_advanced.py"
```
