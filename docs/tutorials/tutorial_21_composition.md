...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/tutorial_21_composition.py
# or, fully offline:
LOCUS_MODEL_PROVIDER=mock python examples/tutorial_21_composition.py
```

## Source

```python
--8<-- "examples/tutorial_21_composition.py"
```
