...
```bash
LOCUS_MODEL_ID=openai.gpt-4.1 python examples/tutorial_43_plugins.py
```

Offline:

```bash
LOCUS_MODEL_PROVIDER=mock python examples/tutorial_43_plugins.py
```
...
```python
--8<-- "examples/tutorial_43_plugins.py"
```
