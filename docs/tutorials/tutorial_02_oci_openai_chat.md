...
```bash
python examples/tutorial_02_oci_openai_chat.py
```

## See also

- [Tutorial 01 — the three OCI client classes side-by-side](tutorial_01_oci_transports.md)
- [Tutorial 03 — OCIResponsesModel and the Responses endpoint](tutorial_03_oci_responses.md)
- [OCI OpenAI-compatible endpoints — Oracle docs](https://docs.oracle.com/iaas/Content/generative-ai/openai-compatible-api.htm)

## Source

```python
--8<-- "examples/tutorial_02_oci_openai_chat.py"
```
