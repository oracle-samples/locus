...
```bash
python examples/tutorial_03_oci_responses.py
```

## See also

- [Tutorial 01 — the three OCI client classes side-by-side](tutorial_01_oci_transports.md)
- [Tutorial 02 — OCIOpenAIModel deep dive](tutorial_02_oci_openai_chat.md)
...
```python
--8<-- "examples/tutorial_03_oci_responses.py"
```
