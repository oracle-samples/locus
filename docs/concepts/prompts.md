...
The model in a locus agent sees three sources of prompt content, in
this order, every iteration:
...
OCI GenAI's V1 transport inherits prompt caching from the underlying
