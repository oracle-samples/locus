...
See [tutorial 59](../tutorials/tutorial_34_emergent_routing.md) for a
...
- Tutorial: [`examples/tutorial_52_cognitive_router.py`](https://github.com/oracle-samples/locus/blob/main/examples/tutorial_52_cognitive_router.py)
