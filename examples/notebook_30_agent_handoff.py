...
Run it:
    .venv/bin/python examples/notebook_30_agent_handoff.py
...
async def main():
    ...
    # The triage seat reads from Locus's "Model B" slot
    # (env: LOCUS_MODEL_ID_B). Set a cheaper/faster model there to cut
