...
Run it
    ...
    python examples/tutorial_61_audio_chat.py

    afplay tutorial_61_answer.wav   # macOS
...
QUESTION_WAV = ROOT / "tutorial_61_question.wav"
ANSWER_MP3 = ROOT / "tutorial_61_answer.mp3"
...
async def main() -> None:
    ...
    print("  Play it on macOS:        afplay tutorial_61_answer.wav")
    print("  Linux (aplay):           aplay tutorial_61_answer.wav")
    print("  Re-encode to mp3:        ffmpeg -i tutorial_61_answer.wav tutorial_61_answer.mp3")
