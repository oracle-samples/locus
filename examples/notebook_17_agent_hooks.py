...
- Multiple hooks compose. Locus iterates them in priority order.

Run it:
    .venv/bin/python examples/notebook_17_agent_hooks.py

The default provider is OCI Generative AI (canonical model id:
