...
def search_products(query: str, max_results: int = 3) -> list[dict]:
    ...
    products = [
        ...
        {"id": 7, "name": "Standing Desk", "price": 449.99, "category": "furniture", "in_stock": True},
        {"id": 8, "name": "Office Chair", "price": 329.99, "category": "furniture", "in_stock": False},
    ]
...
def get_product_details(product_id: int) -> dict:
    ...
    details = {
        1: {"id": 1, "name": "Laptop", "price": 999.99, "specs": "16GB RAM, 512GB SSD, 14\" 2.8K display"},
        2: {"id": 2, "name": "Headphones", "price": 149.99, "specs": "Noise-canceling, 40h battery, USB-C"},
        3: {"id": 3, "name": "Mouse", "price": 49.99, "specs": "Wireless, 16k DPI, programmable buttons"},
        ...
        7: {"id": 7, "name": "Standing Desk", "price": 449.99, "specs": "Sit-stand, 60×30, programmable presets"},
        8: {"id": 8, "name": "Office Chair", "price": 329.99, "specs": "Lumbar support, adjustable arms"},
    }
