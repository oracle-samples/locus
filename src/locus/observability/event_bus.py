...
"""Singleton pub/sub event bus for locus telemetry.

A leaner adaptation of Oracle's optic ``EventBus`` (see
...
The locus hook system (:class:`locus.hooks.HookProvider`) and the
